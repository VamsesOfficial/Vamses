...
let em = res.emoji
  ...
  let arrayMenu = ['all', 'wibu', 'update', 'maker', 'berita', 'edukasi', 'news', 'random', 'logo', 'menbalas', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database','quran', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'nocategory']
...
const sections = [
   {
    ...
    rows: [
        ...
        {title: `⛩️ ${pmenus} List Anime`, rowId: ".? wibu", description: "Kamu wibu ya bang?"},
